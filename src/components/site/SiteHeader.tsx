...
import logo from "@/assets/eddys-logo.png";
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-10 py-4 flex items-center justify-between">
        ...
        >
          <img
            src={logo}
            alt="Eddys AI Lab"
            className="h-11 w-auto block shrink-0 relative top-[2px]"
          />
        ...
        <Sheet>
          <SheetTrigger asChild>
            <button className="md:hidden p-2 -mr-2 cursor-pointer" aria-label="Open menu">
